# 谢氏老中医馆下载站
---
- [下载 ufse.zip](http://qdnas.icu:8080/api/public/dl/S_0kVrQo)
  * UFSE推荐磁盘放在主机环境下用WIN环境去使用会稳定。
  * 使用PE或硬盘盒不适合长时间高功耗工作环境
---
- [下载 MacroritDiskScanner693.zip](http://qdnas.icu:8080/api/public/dl/EIDEVVST)
  * MacroritDiskScanner693是个坏道修复工具不是扫盘回复数据的，谨慎使用+
---
- [下载 HDSentinel.rar](http://qdnas.icu:8080/api/public/dl/DLDnRw5a)
  * 检测硬盘SMART状态和一些简单信息的好工具
---
- [下载 DiskGenius.zip](http://qdnas.icu:8080/api/public/dl/xNUSOumE)
  * 一个老牌的硬盘分区管理工具
---
...
·如果没有挂载成功，在排除了命令的问题，那么你只能尝试使用[UFS](http://qdnas.icu:8080/api/public/dl/S_0kVrQo)来扫盘恢复
